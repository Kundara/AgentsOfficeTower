...
- `icons/worktree.png` and selected `icons/thread-item/*.png` assets are adapted from Justin Arnold's "Justin's 16x16 Icon Pack" (`https://zeromatrix.itch.io/rpgiab-icons`), released under CC BY 4.0.
