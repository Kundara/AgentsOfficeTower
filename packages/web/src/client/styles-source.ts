export const CLIENT_STYLES = `
      ...
      * { box-sizing: border-box; }
      ...
      .hat-preview-frame {
        ...
        border: 1px solid var(--border);
        background:
          linear-gradient(180deg, rgba(11, 20, 18, 0.96) 0%, rgba(17, 29, 25, 0.96) 100%);
        overflow: hidden;
      }

      .hat-preview-frame.is-empty {
        background:
          repeating-linear-gradient(
            135deg,
            rgba(75, 214, 159, 0.08) 0 8px,
            rgba(75, 214, 159, 0.02) 8px 16px
          );
      }
      ...
      .hat-preview-empty {
        width: 22px;
        height: 12px;
        border: 2px dashed rgba(167, 187, 177, 0.55);
        border-bottom: 0;
      ...
      .office-map-hover-layer .agent-hover {
        position: fixed;
        left: 0;
        top: 0;
        bottom: auto;
      ...
      .office-map-hover-layer[data-hover-kind="hot"] .office-wall-hot-hover {
        left: 0;
      ...
      .office-map-hover-layer[data-hover-kind="hot"] .office-wall-hot-hover .agent-hover-title {
        font-size: calc(18px * var(--ui-text-scale));
        margin-bottom: 6px;
      }

      .office-map-wall-hot-hit .office-wall-hot-hover .agent-hover-title strong,
      .office-map-hover-layer[data-hover-kind="hot"] .office-wall-hot-hover .agent-hover-title strong {
        font-size: calc(20px * var(--ui-text-scale));
        line-height: 1.1;
      }

      .office-map-wall-hot-hit .office-wall-hot-hover .agent-hover-meta,
      .office-map-hover-layer[data-hover-kind="hot"] .office-wall-hot-hover .agent-hover-meta {
        font-size: calc(14px * var(--ui-text-scale));
      }
      ...
      .office-map-hover-layer[data-hover-kind="agent"] .agent-hover {
        left: 50%;
        bottom: calc(100% + 2px);
      ...
      .office-map-hover-layer[data-hover-kind="agent"] .agent-hover-title {
        font-size: calc(16px * var(--ui-text-scale));
        margin-bottom: 4px;
      }

      .office-map-agent-hit .agent-hover-title strong,
      .office-map-hover-layer[data-hover-kind="agent"] .agent-hover-title strong {
        font-size: calc(17px * var(--ui-text-scale));
        line-height: 1.1;
      }

      .office-map-agent-hit .agent-hover-summary,
      .office-map-hover-layer[data-hover-kind="agent"] .agent-hover-summary {
        font-size: calc(13px * var(--ui-text-scale));
        line-height: 1.35;
      }

      .office-map-agent-hit .agent-hover-meta,
      .office-map-hover-layer[data-hover-kind="agent"] .agent-hover-meta {
        margin-top: 5px;
      ...
      .agent-hover-title strong.agent-hover-brand-codex {
        color: var(--brand-codex);
      }

      .agent-hover-title strong.agent-hover-brand-claude {
        color: var(--brand-claude);
      }

      .agent-hover-title strong.agent-hover-brand-hermes {
        color: var(--brand-hermes);
      }

      .agent-hover-title strong.agent-hover-brand-cursor {
        color: var(--brand-cursor);
      }

      .agent-hover-title strong.agent-hover-brand-openclaw {
        color: var(--brand-openclaw);
      }
