    ...
    projects: [
      {
        ...
        agents: [
          ...
          },
          {
            ...
            isSubagent: false,
            state: "delegating",
            detail: "Spawning nested multi-agents v2 workers.",
            cwd: `${AUDIT_PROJECT_ROOT}/nested`,
            roomId: "root",
            appearance: auditAppearance("iris", "Iris", "#7b73f0", "#e6e1ff", "#4139a3"),
            updatedAt: isoOffset(1_000),
            stoppedAt: null,
            paths: [`${AUDIT_PROJECT_ROOT}/nested/index.ts`],
            activityEvent: {
              type: "collabAgentToolCall",
              action: "updated",
              path: `${AUDIT_PROJECT_ROOT}/nested/index.ts`,
              title: "Spawning 2 subagents",
              isImage: false
            },
            latestMessage: "Parent coordinating nested subagents.",
            threadId: "audit-thread-nested-lead",
            taskId: null,
            resumeCommand: "codex resume audit-thread-nested-lead",
            url: null,
            git: null,
            provenance: "codex",
            confidence: "typed",
          ...
          {
            id: "audit-nested-child-a",
            label: "Depth 1 Worker",
            source: "local",
            sourceKind: "subAgent",
            parentThreadId: "audit-nested-lead",
            depth: 1,
            isCurrent: true,
            isOngoing: true,
            statusText: "active",
            role: "worker",
            nickname: "Depth 1 Worker",
            isSubagent: true,
            state: "running",
            detail: "Owns the first delegated slice.",
            cwd: `${AUDIT_PROJECT_ROOT}/nested/worker-a`,
            roomId: "root",
            appearance: auditAppearance("fern", "Fern", "#7fbf5b", "#eef8e6", "#476d31"),
            updatedAt: isoOffset(900),
            stoppedAt: null,
            paths: [`${AUDIT_PROJECT_ROOT}/nested/worker-a/task.ts`],
            activityEvent: {
              type: "commandExecution",
              action: "ran",
              path: `${AUDIT_PROJECT_ROOT}/nested/worker-a/task.ts`,
              title: "Running child task",
              isImage: false
            },
            latestMessage: "Depth 1 worker is active.",
            threadId: "audit-thread-nested-child-a",
            taskId: null,
            resumeCommand: "codex resume audit-thread-nested-child-a",
            url: null,
            git: null,
            provenance: "codex",
            confidence: "typed",
          ...
          {
            id: "audit-nested-child-b",
            label: "Depth 1 Mapper",
            source: "local",
            sourceKind: "subAgent",
            parentThreadId: "audit-nested-lead",
            depth: 1,
            ...
            statusText: "active",
            role: "explorer",
            nickname: "Depth 1 Mapper",
            isSubagent: true,
            state: "scanning",
            detail: "Delegates a nested scan.",
            cwd: `${AUDIT_PROJECT_ROOT}/nested/mapper`,
            roomId: "root",
            appearance: auditAppearance("ocean", "Ocean", "#4f9df5", "#d9edff", "#235896"),
            updatedAt: isoOffset(800),
            stoppedAt: null,
            paths: [`${AUDIT_PROJECT_ROOT}/nested/mapper/map.ts`],
            activityEvent: {
              type: "collabAgentToolCall",
              action: "updated",
              path: `${AUDIT_PROJECT_ROOT}/nested/mapper/map.ts`,
              title: "Spawning 1 subagent",
              isImage: false
            },
            latestMessage: "Depth 1 mapper spawned a nested agent.",
            threadId: "audit-thread-nested-child-b",
            taskId: null,
            resumeCommand: "codex resume audit-thread-nested-child-b",
            url: null,
            git: null,
            provenance: "codex",
            confidence: "typed",
          ...
          {
            id: "audit-nested-grandchild",
            label: "Depth 2 Explorer",
            source: "local",
            sourceKind: "subAgent",
            parentThreadId: "audit-nested-child-b",
            depth: 2,
            isCurrent: true,
            isOngoing: true,
            statusText: "active",
            role: "explorer",
            nickname: "Depth 2 Explorer",
            isSubagent: true,
            state: "planning",
            detail: "Nested under a subagent.",
            cwd: `${AUDIT_PROJECT_ROOT}/nested/mapper/deeper`,
            roomId: "root",
            appearance: auditAppearance("sun", "Sun", "#f5b74f", "#fff1c9", "#93661f"),
            updatedAt: isoOffset(700),
            stoppedAt: null,
            paths: [`${AUDIT_PROJECT_ROOT}/nested/mapper/deeper/trace.ts`],
            activityEvent: {
              type: "agentMessage",
              action: "said",
              path: `${AUDIT_PROJECT_ROOT}/nested/mapper/deeper/trace.ts`,
              title: "Depth 2 planning",
              isImage: false
            },
            latestMessage: "Depth 2 explorer is visible.",
            threadId: "audit-thread-nested-grandchild",
            taskId: null,
            resumeCommand: "codex resume audit-thread-nested-grandchild",
            url: null,
            git: null,
            provenance: "codex",
            confidence: "typed",
          ...
          {
            id: "audit-nested-great-grandchild",
            label: "Depth 3 Scout",
            source: "local",
            sourceKind: "subAgent",
            parentThreadId: "audit-nested-grandchild",
            depth: 3,
            isCurrent: true,
            isOngoing: true,
            statusText: "active",
            role: "explorer",
            nickname: "Depth 3 Scout",
            isSubagent: true,
            state: "thinking",
            detail: "Third-level delegated visibility check.",
            cwd: `${AUDIT_PROJECT_ROOT}/nested/mapper/deeper/scout`,
            roomId: "root",
            appearance: auditAppearance("rose", "Rose", "#d86797", "#ffe1ef", "#86385a"),
            updatedAt: isoOffset(600),
            stoppedAt: null,
            paths: [`${AUDIT_PROJECT_ROOT}/nested/mapper/deeper/scout/notes.ts`],
            activityEvent: {
              type: "agentMessage",
              action: "said",
              path: `${AUDIT_PROJECT_ROOT}/nested/mapper/deeper/scout/notes.ts`,
              title: "Depth 3 thinking",
              isImage: false
            },
            latestMessage: "Depth 3 scout is visible and smallest.",
            threadId: "audit-thread-nested-great-grandchild",
            taskId: null,
            resumeCommand: "codex resume audit-thread-nested-great-grandchild",
            url: null,
            git: null,
            provenance: "codex",
            confidence: "typed",
          ...
          hotChanges: [
            {
              ...
              label: "HeroPanel.tsx",
              fileType: "script",
              branch: "feature/audit-hot-board",
              branches: ["feature/audit-hot-board"],
              users: ["Audit Teammate"],
              heat: 82,
              score: 20.5,
              changeCount: 3,
              lastChangedAt: isoOffset(4_000),
              linesAdded: 18,
              linesRemoved: 5,
              agents: ["File Approval"],
              provenance: "codex",
              confidence: "typed"
            }
          ],
